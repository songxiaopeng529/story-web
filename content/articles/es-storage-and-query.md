...
![写入：一条数据的完整时间线](/images/articles/es-storage-and-query/wb1.jpg)
...
![先算它该去哪个抽屉（路由）](/images/articles/es-storage-and-query/wb2.jpg)
...
![三个后台动作：refresh / flush / merge](/images/articles/es-storage-and-query/wb3.jpg)
...
![查询：两轮问答（Query Phase + Fetch Phase）](/images/articles/es-storage-and-query/wb4.jpg)
...
![钻进一个 shard 里看（一次查询读了哪些文件）](/images/articles/es-storage-and-query/wb5.jpg)
...
![这一路谁在干活（Lucene / Netty / JVM / OS）](/images/articles/es-storage-and-query/wb6.jpg)
